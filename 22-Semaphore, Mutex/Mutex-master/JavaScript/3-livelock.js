...
// Лайвлок это когда два треда что-то делают, но при этом друг другу мешают.
// То один приведет процесс в одно состояние, а другой возьмет и поменяет.
// В итоге они так и не могут достич нужного результата.
