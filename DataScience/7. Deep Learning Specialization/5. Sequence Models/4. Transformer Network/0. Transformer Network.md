...
│ papers in AI history, with 100,000+ citations.                      │
└─────────────────────────────────────────────────────────────────────┘
```
...
• Information flows LEFT → RIGHT only
• x₁ must pass through h₂, h₃, h₄ to influence h₅
...
• ALL positions connected to ALL other positions
• x₁ directly influences z₅ through attention
• Parallel, fast, no information bottleneck
```
...
Symbol Legend:
──────────────
×N = Stack of N identical layers (N=6 in original)
