...
- [Что такое TF-IDF?](#что-такое-tf-idf)
- [Что такое BM25?](#что-такое-bm25--объяснение)
- [Как правильно предобработать текст?](#как-правильно-предобработать-текст)
- [Предобработка текста | Стемминг | Лемматизация](#предобработка-текста--стемминг--лемматизация)
- [Какие бывают метрики близости текста?](#какие-бывают-метрики-близости-текста--объяснение)
- [Что такое Word2Vec?](#что-такое-word2vec)
  - [Continuous Bag of Words - CBOW](#1-continuous-bag-of-words---cbow)
  - [Skip Gram](#2-skip-gram---когда-мы-имея-предсказываем-контекст-по-целевому-слову)
- [Что такое Negative Sampling?](#что-такое-negative-sampling)
- [Отличие между Word2Vec и TF-IDF?](#отличие-между-word2vec-и-tf-idf)
