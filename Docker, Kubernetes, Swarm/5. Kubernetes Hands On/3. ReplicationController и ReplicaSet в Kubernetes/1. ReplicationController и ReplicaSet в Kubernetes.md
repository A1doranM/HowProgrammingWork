...
Отвечает за поддержание работы кластера в соответствии с требованиями. Например: если запущенно слишком мало
ексземпляров то запустит новые, если слишком много, уберет лишние.
...
Полностью заменяет контроллер и является его более продвинутой версией
