...
// Иначе говоря не стоит заставлять клиент реализовывать функции интерфейса которые он не реализовывает.
// Это несколько пересекается с первым принципом, и создавая интерфейс мы должны создавать его для
// конкретной задачи, а не пытаться засунуть методы на все случаи жизни.
