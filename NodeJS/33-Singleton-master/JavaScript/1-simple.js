...
// Синглтон - шаблон одиночка, в целом в JS он почти бесполезен, но ниже приведен пример реализации его.
...
function Singleton() {
  ...
  Singleton.instance = this; // Создаем его.
                             // Таким образом каждый раз мы будем возвращать один и тот же инстанс.
}
