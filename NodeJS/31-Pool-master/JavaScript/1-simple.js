...
const pool = item => {
  ...
  // то есть в начале отдаем все что есть, если кончилось создаем новые элементы. Это не совсем правильно, поскольку сама идея пула это
  // создавать ограниченное количество элементов и не давать его превышать.
