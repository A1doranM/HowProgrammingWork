...
// Композиция это способ из нескольких функций сделать одну объединив
// их в цепочку слева направо, или справа на лево.

// Пример с суперпозицией функций.
...
// Суперпозиция - выполнение происходит сразу после вызова функций.
// А по правильному должна возвращаться функция вызвав которую мы получим
