...
// Пример с функцией принимающей много аргументов.
// Пайп это функция которая результат одной функции запихивает в другую.
// Пайп имеет обратный порядок выполнения переданных функций. В целом отличие
// от композиции только в этом.
