...
// Парсер написанный в автоматном стиле. На автоматах очень удобно программировать технику,
// сетевые протоколы, парсеры, компиляторы, все где есть четко выделенные состояния между которыми
// происходят переходы.
